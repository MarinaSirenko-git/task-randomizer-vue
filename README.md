**[Task Randomizer](https://task-randomizer-vue.pages.dev/)** - проект, который я написала что бы изучить Pinia. Ниже этапы, которые были пройдены при переносе логики из компонента в стейт-менеджер.
